%% All the domain and subdomain labels here

%% ========================================================================
%  Define Domain Structure for QPP Analysis
% ========================================================================

% Define the networks with their properties
Networks = struct( ...
    'Name',    {'CB', 'VI', 'PL', 'SC', 'SM', 'HC', 'TN'}, ...   % Network Names
    'ICNs',    {1:13, 14:25, 26:36, 37:54, 55:68, 69:90, 91:105}, ... % ICNs Indices
...
for i = 1:numel(Networks)
    icn_indices = Networks(i).ICNs; % Extract ROI indices
...
% Define the subdomains with their properties
Subdomains = struct( ...
